      ...
      <div className="glass-premium p-8 rounded-[2rem] border-white/10 glow-primary relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <Button
            ...
            disabled={isLoading}
            variant="outline"
            className="w-full h-12 rounded-xl border-white/10 bg-white/5 hover:bg-white/10 text-white font-bold flex items-center justify-center gap-3 transition-all group"
          >
